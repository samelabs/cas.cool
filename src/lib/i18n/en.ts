...
export const en = {
  ...
  about: {
    ...
    description:
      'CAS.cool is a community for people passionate about chemistry — discover compounds by CAS Registry Number, share knowledge, follow peers, and discuss all things chemical.',
    features: 'Key Features',
    casNumbered: 'CAS-Numbered Posts',
    casNumberedDesc: 'Every post can be tagged with a CAS Registry Number for instant discoverability.',
    quoteRepost: 'Quote & Repost',
    quoteRepostDesc: 'Share and quote posts to amplify reach across the community.',
    directMessaging: 'Direct Messaging',
    directMessagingDesc: 'Connect privately with other members to discuss chemistry.',
    smartSearch: 'Smart Search',
    smartSearchDesc: 'Search by CAS number, chemical name, or username across the entire platform.',
    cta: 'Join the chemistry community today.',
  },
